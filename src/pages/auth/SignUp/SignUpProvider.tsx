                            ...
                            <div className="cont__camp">
                                ...
                                <div className="camp__inputs">
                                    ...
                                    <section className="camp__text">
                                        <h3 className="camp__title">Registrar proveedor</h3>
                                    </section>
                                    <div className="camp">
                                    ...
                                    <div className="camp">
                                        ...
                                        <input className="camp__txt" type="password" name="password" id="prov_contrasenia" placeholder='mi contraseña'></input>
                                    </div>
